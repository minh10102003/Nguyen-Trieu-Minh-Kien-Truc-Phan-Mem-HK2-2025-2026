...
/**
 * Design Pattern Demo: Observer (Stock, Task) & Adapter (XML to JSON).
 * Author: Nguyen Trieu Minh | MSSV: 21103201 | nguyentrieuminh1003@gmail.com | Chuyên ngành: Kỹ thuật phần mềm
 */
public class Main {
